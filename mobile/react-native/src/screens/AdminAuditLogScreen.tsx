...
export default function AdminAuditLogScreen() {
  ...
  const { data, isLoading, error, refetch } = (trpc as any)['admin']?.['getAuditLog']?.useQuery?.() ?? { data: null, isLoading: false, error: null, refetch: async () => {} };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView
        ...
        accessibilityLabel="Audit Log content"
      >
        {data ? (
          ...
          <View style={styles.emptyState}>
            <Text style={styles.emptyTitle}>No Audit Log Data</Text>
