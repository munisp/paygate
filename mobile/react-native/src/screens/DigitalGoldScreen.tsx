 ...
 * Wired to tRPC procedure: digitalGold.getHoldings
 */
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.centered}>
          ...
          <Text style={styles.loadingText}>Loading Digital Gold...</Text>
        </View>
      </SafeAreaView>
    );
  }
  ...
  if (error) {
    return (
      <SafeAreaView style={styles.container}>
        <StatusBar barStyle="light-content" backgroundColor={colors.background} />
        <View style={styles.centered}>
          <Text style={styles.errorText}>Failed to load Digital Gold</Text>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView
        ...
        accessibilityLabel="Digital Gold content"
      >
        {data ? (
          ...
          <View style={styles.emptyState}>
            <Text style={styles.emptyTitle}>No Digital Gold Data</Text>
