...
const InsuranceHubScreen: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      // TODO: wire to real tRPC endpoint: trpc.insurancePolicies.list
      const response = await fetch('/api/trpc/insurancePolicies.list?input={}', {
        credentials: 'include',
      });
  ...
  if (isLoading) {
    return (
      <View style={styles.center}>
        ...
        <Text style={styles.loadingText}>Loading Insurance Hub...</Text>
      </View>
    );
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <Text style={styles.emptyText}>No Insurance Hub data available.</Text>
        }
      />
    </View>
  );
