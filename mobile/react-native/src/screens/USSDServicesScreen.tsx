...
/**
 * USSD Services Screen
 * Auto-generated parity screen for PayGate Merchant Portal mobile app.
 * Wired to tRPC procedure: ussd.listSessions
 */
export default function USSDServicesScreen() {
  const navigation = useNavigation();
  const [refreshing, setRefreshing] = useState(false);

  const { data, isLoading, error, refetch } = (trpc as any)['ussd']?.['listSessions']?.useQuery?.() ?? { data: null, isLoading: false, error: null, refetch: async () => {} };
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.centered}>
          ...
          <Text style={styles.loadingText}>Loading USSD Services...</Text>
        </View>
      </SafeAreaView>
    );
  }
  ...
  if (error) {
    return (
      <SafeAreaView style={styles.container}>
        <StatusBar barStyle="light-content" backgroundColor={colors.background} />
        <View style={styles.centered}>
          <Text style={styles.errorText}>Failed to load USSD Services</Text>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView
        ...
        accessibilityLabel="USSD Services content"
      >
        {data ? (
          ...
          <View style={styles.emptyState}>
            <Text style={styles.emptyTitle}>No USSD Services Data</Text>
