 ...
 * Wired to tRPC procedure: crypto.getWallet
 */
export default function CryptoWalletScreen() {
  const navigation = useNavigation();
  const [refreshing, setRefreshing] = useState(false);

  const { data, isLoading, error, refetch } = (trpc as any)['crypto']?.['getWallet']?.useQuery?.() ?? { data: null, isLoading: false, error: null, refetch: async () => {} };
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.centered}>
          ...
          <Text style={styles.loadingText}>Loading Crypto Wallet...</Text>
        </View>
      </SafeAreaView>
    );
  }
  ...
  if (error) {
    return (
      <SafeAreaView style={styles.container}>
        <StatusBar barStyle="light-content" backgroundColor={colors.background} />
        <View style={styles.centered}>
          <Text style={styles.errorText}>Failed to load Crypto Wallet</Text>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView
        ...
        accessibilityLabel="Crypto Wallet content"
      >
        {data ? (
          ...
          <View style={styles.emptyState}>
            <Text style={styles.emptyTitle}>No Crypto Wallet Data</Text>
