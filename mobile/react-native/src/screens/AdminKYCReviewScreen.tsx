 ...
 * Wired to tRPC procedure: admin.getKYCSubmissions
 */
export default function AdminKYCReviewScreen() {
  const navigation = useNavigation();
  const [refreshing, setRefreshing] = useState(false);

  const { data, isLoading, error, refetch } = (trpc as any)['admin']?.['getKYCSubmissions']?.useQuery?.() ?? { data: null, isLoading: false, error: null, refetch: async () => {} };
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.centered}>
          ...
          <Text style={styles.loadingText}>Loading KYC Review...</Text>
        </View>
      </SafeAreaView>
    );
  }
  ...
  if (error) {
    return (
      <SafeAreaView style={styles.container}>
        <StatusBar barStyle="light-content" backgroundColor={colors.background} />
        <View style={styles.centered}>
          <Text style={styles.errorText}>Failed to load KYC Review</Text>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView
        ...
        accessibilityLabel="KYC Review content"
      >
        {data ? (
          ...
          <View style={styles.emptyState}>
            <Text style={styles.emptyTitle}>No KYC Review Data</Text>
