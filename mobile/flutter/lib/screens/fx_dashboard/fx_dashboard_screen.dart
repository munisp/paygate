...
class FxDashboardScreen extends StatefulWidget {
  const FxDashboardScreen({super.key});
  @override
  State<FxDashboardScreen> createState() => _FxDashboardScreenState();
}

class _FxDashboardScreenState extends State<FxDashboardScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  String? _error;
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          Text('No Fx Dashboard data', style: const TextStyle(color: Colors.grey)),
                        ],
                      ),
                    )
                  : RefreshIndicator(
