...
class ChargebacksScreen extends StatefulWidget {
  ...
  @override
  State<ChargebacksScreen> createState() => _ChargebacksScreenState();
}

class _ChargebacksScreenState extends State<ChargebacksScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      // TODO: Wire to tRPC/chargebacks API endpoint
