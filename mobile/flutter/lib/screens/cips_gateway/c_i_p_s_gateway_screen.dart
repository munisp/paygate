...
class CIPSGatewayScreen extends ConsumerStatefulWidget {
  const CIPSGatewayScreen({super.key});
  @override
  ConsumerState<CIPSGatewayScreen> createState() => _CIPSGatewayScreenState();
}

class _CIPSGatewayScreenState extends ConsumerState<CIPSGatewayScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: _bg,
      appBar: AppBar(
        title: const Text('CIPS Gateway', style: TextStyle(color: _text)),
        backgroundColor: _bg,
