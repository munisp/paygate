...
class _AuditLogViewerScreenState extends ConsumerState<AuditLogViewerScreen> {
  ...
  Future<void> _loadData({bool refresh = false}) async {
    ...
    try {
      ...
      final result = await api.searchAuditLogs(page: _page);
        ...
        child: _error != null
            ? Center(
                child: Column(
                  ...
                  children: [
                    Icon(Icons.history, size: 48, color: Colors.red[300]),
                ...
                : _items.isEmpty
                    ? Center(
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Icon(Icons.history, size: 64, color: Colors.blue[200]),
                            const SizedBox(height: 16),
                            Text('No Audit Log found', style: Theme.of(context).textTheme.titleMedium),
                            const SizedBox(height: 8),
