...
class EscrowAccountsScreen extends StatefulWidget {
  ...
  @override
  State<EscrowAccountsScreen> createState() => _EscrowAccountsScreenState();
}

class _EscrowAccountsScreenState extends State<EscrowAccountsScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      // TODO: Wire to tRPC/escrow API endpoint
