...
class _MobileMoneyReconScreenState extends State<MobileMoneyReconScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      // TODO: Wire to tRPC/mobile_money API endpoint
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'Failed to load Mobile Money Recon',
