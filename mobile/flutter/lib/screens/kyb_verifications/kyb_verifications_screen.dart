...
class _KybVerificationsScreenState extends ConsumerState<KybVerificationsScreen> {
  ...
  Future<void> _loadData({bool refresh = false}) async {
    ...
    try {
      ...
      final result = await api.listKybVerifications(page: _page);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('KYB Verifications'),
        actions: [
          IconButton(
        ...
        child: _error != null
            ? Center(
                child: Column(
                  ...
                  children: [
                    Icon(Icons.verified_user, size: 48, color: Colors.red[300]),
                ...
                : _items.isEmpty
                    ? Center(
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Icon(Icons.verified_user, size: 64, color: Colors.purple[200]),
                            const SizedBox(height: 16),
                            Text('No KYB Verifications found', style: Theme.of(context).textTheme.titleMedium),
                            const SizedBox(height: 8),
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                leading: CircleAvatar(
                                  ...
                                  child: Icon(Icons.verified_user, color: Colors.purple[700], size: 20),
                                ),
                                title: Text(
                                  item['businessName'] ?? item['label'] ?? 'Verification',
